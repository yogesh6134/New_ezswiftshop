...
const PaymentMethod = (props) => {
    ...
    const payHandler = async () => {
        ...
        if (method === 'wallet money') {
            let res = await axios.get("http://100.26.11.43/orders/ewallet-checkout-payment/?order_id=" + order_id)
            ...
            props.navigation.navigate('payment', { order_id:order_id ,type: 'Shop'})
