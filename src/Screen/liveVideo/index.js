...
import { Button, View, StyleSheet, Text, TextInput, PermissionsAndroid } from 'react-native'
          ...
          try {
              ...
              if (!cameraGranted || !audioGranted) {
                  ...
                  if (granted[PermissionsAndroid.PERMISSIONS.CAMERA] !== PermissionsAndroid.RESULTS.GRANTED ||
                      ...
                      console.log('Camera and Audio permissions are required to use this feature.');
                  }
              }
          } catch (err) {
              console.warn(err);
